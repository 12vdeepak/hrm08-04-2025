                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-8">
                                    <select
                                        ...
                                        <option value="india"  {{ old('shift_type', 'india') == 'india'  ? 'selected' : '' }}>India - 9am to 7pm (IST)</option>
                                        <option value="uk"     {{ old('shift_type') == 'uk'     ? 'selected' : '' }}>UK EU UAE - 3pm to 12am (IST)</option>
                                        <option value="us"     {{ old('shift_type') == 'us'     ? 'selected' : '' }}>US - 7pm to 4am (IST)</option>
                                        <option value="anz"    {{ old('shift_type') == 'anz'    ? 'selected' : '' }}>ANZ - 5am to 2pm (IST)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
