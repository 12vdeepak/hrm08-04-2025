...
@section('content')
    ...
    <div class="row">
        <form action="{{ route('create_hr_time_tracker_info') }}" method="POST">
            @csrf
            <div class="col-md-12 ">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-8">
                                    <select
                                        class="form-control @error('project_name') is-invalid @enderror custom-select select2 select2-hidden-accessible"
...
@section('modals')
    <div class="modal fade" id="project_name" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="projectname-form" action="{{ route('hr_add_project_name') }}" method="POST">
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal fade" id="job_name">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="jobname-form" action="{{ route('hr_add_job_name') }}" method="POST">
                        @csrf
                        <div class="form-group">
