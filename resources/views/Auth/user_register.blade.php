                        ...
                        <div class="col-md-8 col-lg-6 col-xl-4 col-xxl-4">
                            <div class="card my-5">
                                <div class="p-4 pt-6 text-center">
                                    <h1 class="mb-2">Quantum User Register</h1>
                                </div>
                                <form class="card-body pt-3" action="{{ route('user_register_post') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control"  type="email" placeholder="Email" id="email" name="email" value={{$user->email}} readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
