                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="user-info">
                            ...
                            <span
                                class="text-muted app-sidebar__user-name text-sm">{{ auth()->user()->title->name }}</span>
                            <span class="text-muted app-sidebar__user-name"
                                style="font-size: 14px; font-weight:400;">{{ auth()->user()->department->name }}</span>
                        </div>
                    </div>
                </div>
                ...
                <ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item"
                            href="{{ route('attendance', ['start_date' => 0, 'end_date' => 0]) }}">
                    ...
                    <li class="slide">
                        <a class="side-menu__item"
                            href="{{ route('view_time_tracker_info', ['start_date' => 0, 'end_date' => 0]) }}">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('employee.files') }}">
