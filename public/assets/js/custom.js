/******/ (() => {
  ...
  \***************************************/
            /***/ function () {
                ...
                (function ($) {
                    ...
                    $(document).ready(function () {
                        $("#Password-toggle a").on("click", function (event) {
                            ...
                            if (
                                $("#Password-toggle input").attr("type") ==
                                "text"
                            ) {
                                $("#Password-toggle input").attr(
                                    "type",
                                    "password"
                                );
                        ...
                        $("#Password-toggle1 a").on("click", function (event) {
                            ...
                            if (
                                $("#Password-toggle1 input").attr("type") ==
                                "text"
                            ) {
                                $("#Password-toggle1 input").attr(
                                    "type",
                                    "password"
                                );
                                ...
                                $("#Password-toggle1 i").removeClass(
                                    "fe-eye-off"
                                );
                        ...
                        $("#Password-toggle2 a").on("click", function (event) {
                            ...
                            if (
                                $("#Password-toggle2 input").attr("type") ==
                                "text"
                            ) {
                                $("#Password-toggle2 input").attr(
                                    "type",
                                    "password"
                                );
                                ...
                                $("#Password-toggle2 i").removeClass(
                                    "fe-eye-off"
                                );
                ...
                if (!document.querySelector("body").firstElementChild.classList.contains("responsive-log") 
                      &&
                    !document.body.classList.contains("main-content")) {
                    // ***** closed menu *****//
                ...
                if (bodyhorizontal) {
                    ...
                    if (
                        !document
                            .querySelector("body")
                            .classList.contains("login-img") &&
                        !$("body").hasClass("main-content")
                    ) {
                        ...
                        (_document$querySelect = document.querySelector(
                            ...
                            ? void 0
                            : _document$querySelect.classList.add(
                                  "flex-nowrap"
                              );
                        responsive();
                    }
                    ...
                    if (bodyhorizontalHover) {
                        ...
                        if (
                            ...
                            (_document$querySelect2 = document.querySelector(
                                ...
                                ? void 0
                                : _document$querySelect2.classList.add(
                                      "flex-nowrap"
                                  );
                            HorizontalHovermenu();
                            checkHoriMenu();
                ...
                if (bodyRtl) {
                    ...
                    (_document$getElementB =
                        document.getElementById("style")) === null ||
                    _document$getElementB === void 0
                        ? void 0
                        : _document$getElementB.setAttribute(
                              "href",
                              "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.rtl.css"
                          );
                }
                /***************** RTL HAs Class *********************/
